                        ...
                        <form method="POST" action="<?php echo pg; ?>/processa/proc_edit_pagina">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="nome_pagina" text="text" class="form-control" id="nome" placeholder="Nome da página" value="<?php
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="keywords" text="text" class="form-control" id="nome" placeholder="Palavra chave da página" value="<?php
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    ?>
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="A página deve ser indexada pelos buscadores." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                                ...
                                <div class="form-group col-md-4">
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="Página pública significa que para acessar a página não é necessário fazer login ou estar logado no administrativo." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    ?>
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="Quando a página é dependente, por exemplo 'processa/proc_cad_usuario' é dependente da página 'cadastrar/cad_usuario', ao liberar a página 'cadastrar/cad_usuario' é liberado automaticamente a página 'processa/proc_cad_usuario'." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <?php
                                    $result_grps_pgs = "SELECT id, nome FROM adms_grps_pgs ORDER BY id ASC";
                                    $resultado_grps_pgs = mysqli_query($conn, $result_grps_pgs);
                                    ?>
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="Selecionar a qual grupo a página pertence." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                                    ...
                                    <select name="adms_grps_pg_id" id="adms_grps_pg_id" class="form-control">
                                        ...
                                        while ($row_grps_pgs = mysqli_fetch_assoc($resultado_grps_pgs)) {
                                            if (isset($_SESSION['dados']['adms_grps_pg_id']) AND ( $_SESSION['dados']['adms_grps_pg_id'] == $row_grps_pgs['id'])) {
                                                echo "<option value='" . $row_grps_pgs['id'] . "' selected >" . $row_grps_pgs['nome'] . "</option>";
                                                //Preencher com informações do banco de dados caso não tenha nenhum valor salvo na sessão $_SESSION['dados']
                                            } elseif (!isset($_SESSION['dados'] ['adms_grps_pg_id']) AND ( isset($row_edit_pg['adms_grps_pg_id']) AND ( $row_edit_pg['adms_grps_pg_id'] == $row_grps_pgs['id']))) {
                                                echo "<option value='" . $row_grps_pgs['id'] . "' selected >" . $row_grps_pgs['nome'] . "</option>";
                                            } else {
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    ?>
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="Selecionar o tipo de arquivo, ao qual diretório pertence no projeto." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    ?>
                                    <label>
                                        <span tabindex="0" data-toggle="tooltip" title="Selecionar a situação da página no projeto." data-placement="top">
                                            <i class="fa fa-question-circle" aria-hidden="true"></i>
                                        </span>
                                        <span class="text-danger">*</span> Situação da página
                                    </label>
                            ...
                            <input name="SendEditPg" type="submit" class="btn btn-warning" value="Salvar Edição">
                        </form>
                    </div>
                </div>
