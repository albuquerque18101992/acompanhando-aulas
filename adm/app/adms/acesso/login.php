...
<body class="text-center">
    <form class="form-signin" method="POST" action="<?php echo pg . '/acesso/valida'; ?>">
        ...
        <h3 class="h3 mb-3 font-weight-normal">Sperrgebiet</h3>
        <?php
        ...
        <input type="submit"  class="btn btn-lg btn-primary btn-block" value="Acessar - Zugriff" name="SendLogin">
        <p class="text-center">Esqueceu a senha ?</p><br>Passwort vergessen
